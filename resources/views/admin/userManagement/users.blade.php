                    ...
                    <tr id="row{{$row->id}}">
                        ...
                        <td class="align-middle text-center">
                            @if (empty($row->profile_photo_path))
                                <img alt="image" class="avatar avatar-md rounded-circle" src="{{asset('public/img/photo.png')}}">
                            @else
                ...
                <div class="modal-body pd-20">
                    ...
                    <form method="post" id="createform">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input  name="user_photo" type="file" class="dropify mt-3" data-default-file="{{asset('public/img/photo.png')}}" data-height="180" data-max-file-size="0.5M"  />
                        </div>
                ...
                <div class="modal-body pd-20">
                    ...
                    <form method="post" id="editpassword">
                        <div class="form-group mt-3">
                            ...
                            <input name="user_password"  type="password" class="form-control password" placeholder="New Pasword" id="user_password" autocomplete="off">
                        </div>
                        <div class="form-group mt-3">
                            <label>Password Confirm</label>
...
@section('jquery')
    ...
    <script>
        ...
        $('body').on('click', '.edit', function() {
            ...
            $('.alert').hide();
            url = '{{ url("admin/users-manage") }}' + '/' + id + '/' + "edit";
