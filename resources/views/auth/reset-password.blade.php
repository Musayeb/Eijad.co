            ...
            <div class="styled-form pt-3">
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group">
                        <label>Email</label>
                        <input  type="email" name="email" value="{{old('email', $request->email)}}" required placeholder="Enter Email" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group text-center mt-4">
                        {{-- <button type="submit" class="theme-btn submit" sty><span class="">  {{ __('Reset Password') }} <i class="fa fa-angle-right"></i></span></button> --}}
                        <button type="submit" class="btn btn-block btn-danger"><span class="txt">Reset Password <i class="fa fa-angle-right"></i></span></button>
